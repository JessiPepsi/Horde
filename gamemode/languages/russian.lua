...
На {1} больше урона в голову. ({2} за каждый уровень, вплоть до {3}).
...
На {1} увеличен урон от режущих и дробящих ударов. ({2} за каждый уровень, вплоть до {3}).
...
{1} шанс нанести критическое попадание. ({2} + {3} за каждый уровень, вплоть до {4}).
Вы наносите на 50% больше урона при критическом попадании.

Нажмите F чтобы войти в режим безумия, заменяющий ваш фонарь.
Вы теряете 1 здоровье каждые 0.2 секунды в режиме безумия, вплоть до 1.
...
Вы получаете 1 стак фаланги каждые 2 секунды вплоть до {1}.
Каждый стак увеличивает +{2} устойчивость от физ. урона и +{3} урон в ближ. бою.
...
Ограничение высасывания вплоть до 10 единиц здоровья за удар.]]
